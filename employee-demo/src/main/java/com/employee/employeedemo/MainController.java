...
public class MainController {
  ...
  @GetMapping(path="/all")// This returns a JSON or XML with the users
  public @ResponseBody Iterable<EmployeeEntity> getAllUsers() {return employeeRepository.findAll();}
}